...
//        int config_port = Integer.parseInt(args[1]);
        ...
        M_Ccs ccs = new M_Ccs(log, v);
        Ccs_Interface itfc = new Ccs_Interface(ccs);
        scon = new ServerCom (v.sockets.Ccs_socket.port);                     // criação do canal de escuta e sua associação
